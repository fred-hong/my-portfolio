...
function Navbar() {
  return (
    <header className="flex justify-between items-center fixed top-0 z-10 py-0 px-12 w-full h-24 bg-header-rgba filter-none pointer-events-none select-auto box-border">
      {/* menu */}
